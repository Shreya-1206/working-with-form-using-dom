...
formEl.addEventListener('submit', function (evt) {
  ...
  const getFormValues = [...evt.target.elements].filter(el => el.type !== 'submit' && el).map(el => {
    //filter submit button becoz we dont need it 
    return {
      //map is use to get all the values here using the 'name attributcheckbox is checked with the help of el.checked property
